...
@section('content')
    ...
    <section>
        <div class="py-4 sm:py-8 lg:py-14 px-4 mx-auto max-w-screen-lg">
            <header>
                <h2 class="text-3xl mx-auto font-bold text-gray-800 mb-8 border-l-4 border-primary-900 ps-2">Keunggulan</h2>
            </header>
    ...
    <section class="py-8 bg-gray-100" id="products">
        <div class="container mx-auto px-4 max-w-screen-lg min-h-96">
            <header>
                <h2 class="text-3xl mx-auto font-bold text-gray-800 mb-8 border-l-4 border-primary-900 ps-2">Daftar Produk / Jasa</h2>
            </header>
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-1 flex items-center justify-between">
                                ...
                                <button
                                    class="px-4 py-2 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 transition duration-200">
                                    Pesan
                                </button>
                            </div>
                        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 border-l-4 border-primary-900 ps-2">Alamat
                </h2>
