...
@section('content')
    ...
    <section>
        <div class="py-4 sm:py-8 lg:py-14 px-4 mx-auto max-w-screen-lg grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <section class="py-8 bg-gray-100" id="products">
        <div class="container mx-auto px-4 max-w-screen-lg">
            <header>
                <h2 class="text-3xl font-bold text-gray-800 mb-8">Daftar Produk / Jasa</h2>
            </header>
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-1 flex items-center justify-between">
                                <span class="text-gray-700 font-medium">Rp{{ rtrim(rtrim(number_format($product->price, 2, ',', '.'), '0'), ',') }} /
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-8 items-center py-8 px-4 mx-auto md:max-w-screen-lg xl:gap-8 lg:grid md:grid-cols-3 sm:py-16 lg:px-6">
            <figure class="md:col-span-2">
                {!! $umkm->googlemap !!}
            </figure>
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Alamat
                </h2>
